...
`*`
It means italic. e.g: *hello*

`**`
It means bold. e.g: **hello**
...
`\`
In the Quarto Markdown, it means escape / line break.

`![](url)`
It means insert pictures.
...
They looked the same in the .html and the .qmd file. You need to put them into ````{r}``` to make them into a code (like what it shows in the exercise 3). 
...
It shows error: object `seq()` not found.
